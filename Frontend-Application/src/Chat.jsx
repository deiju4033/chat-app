...
import wtspSent from '../src/assets/watsp-sent.png'
...
function Chat({socket,username,roomId}) {
  ...
  return (
   ...
   <div style={{width:'358px'}} className='border border-2 shadow rounded-2 mt-4  mb-5'>
   <div className='header d-flex  align-items-center bg-info  text-white rounded-top-2  px-2'>
